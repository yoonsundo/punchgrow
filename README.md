...
| 릴리스 v0.4.0 | 현재 main |
| --- | --- |
| **2026-08-18 Homebrew 릴리스**<br />64개 시작 계보 · 256종 · 64개 중 ORIGIN 도달 계보 7개(약 10.9%)<br />일반·대형 먹이 · ad-hoc 서명 | **현재 소스·공개 도감**<br />릴리스와 동일한 64개 시작 계보 · 256종<br />대형·특대형 먹이와 더 빠른 길게 누르기 · 다음 릴리스 예정 |
...
> [!NOTE]
> 아래 먹이 구성과 기존 일반 먹이 전환은 `v0.4.0` 이후의 현재 `main` 기준입니다. Homebrew `v0.4.0`은 일반·대형 먹이를 제공합니다.
...
| 특대형 먹이 | 구매 `2,500,000` 토큰 · XP `+1,000` · 친밀도 `+50` (대형의 정확히 5배) |
| 기존 일반 먹이 전환 | 5개당 대형 먹이 1개 · 남은 수량은 개당 `100,000` 토큰 환급 |
